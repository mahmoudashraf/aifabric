...
export const demoBackendArchitectures = {
  ...
  incidentInvestigation: {
    ...
    summary:
      "A Spring Boot proof for fixed sequential and parallel specialist plans, strict all-required fan-in, deterministic aggregation, bounded delegation and handoff, and a backend-owned incident conversation manager.",
    diagram: [
      {
        title: "Investigation UI",
        subtitle: "Session-isolated operations lab",
        tone: "ui",
        items: ["Immutable evidence branches", "Plan comparison and timeline", "Transition and conversation labs"],
      },
      {
        title: "Incident API",
        subtitle: "Server-owned execution context",
        tone: "api",
        items: ["Opaque demo sessions", "Idempotency keys", "Safe typed projections"],
      },
      {
        title: "Execution runtime",
        subtitle: "Exact specialists and fixed plans",
        tone: "framework",
        items: ["Service and change specialists", "Sequential or parallel fan-out", "Deterministic citation validator"],
      },
      {
      ...
      {
        title: "Conversation and provider",
        subtitle: "Backend-owned memory",
        tone: "provider",
        items: ["OpenAI live generation", "Bounded chat snapshots", "H2/PostgreSQL session storage"],
      },
    ],
    developer: {
    ...
    aiSurface: [
      "Exact-version specialist manifests define typed service-health, change-risk, intake, and conversation-manager contracts.",
      "Fixed plans run the same independent branches sequentially or in parallel under ALL_REQUIRED fan-in.",
      "The application aggregator validates every output citation against the immutable incident source set before returning an assessment.",
    ...
    providers: [
      ...
      "JDBC chat-session and domain storage preserve bounded conversation history.",
    ],
    flow: [
      "The browser creates an opaque session bound to one immutable incident scenario.",
      "AI Fabric runs service-health and change-risk specialists through the selected fixed plan.",
