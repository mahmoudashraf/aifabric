...
export const demoBackendArchitectures = {
  liveDataSync: {
    ...
    diagram: [
      {
        ...
        tone: "ui",
        items: ["Edit and delete source rows", "Compare DB/vector revisions", "Reusable AI Fabric Chat UI"],
      },
      {
        title: "Domain API",
        subtitle: "Spring Boot + JPA",
        tone: "api",
        items: ["Session-isolated workspaces", "Normal entity service calls", "No indexing API in controllers"],
      },
      {
        title: "Annotation lifecycle",
        subtitle: "AI Fabric indexing",
        tone: "framework",
        items: ["@AICapable entity contract", "@AISearchable + @AIContext extraction", "@AIProcess create/update/delete"],
      },
      {
      ...
      },
      {
        ...
        tone: "provider",
        items: ["Spring AI OpenAI", "Lucene vectors", "H2 source database"],
      },
    ],
    developer: {
    ...
    flow: [
      ...
      "A normal JPA service save returns an annotated entity; @AIProcess invokes synchronous AI Fabric indexing.",
      "AnnotationFieldScanner builds vector content and metadata from @AISearchable and @AIContext fields.",
      "The UI reads source rows and vector records independently and compares their revision metadata.",
