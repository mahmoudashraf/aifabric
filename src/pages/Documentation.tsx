...
const primarySections = [
  ...
  },
  {
    ...
    description: "Install AI Fabric 0.6.1, choose the smallest useful module set, and add your first AI-enabled application capability.",
...
const releaseFacts = [
  { value: "0.6.1", label: "Current release" },
