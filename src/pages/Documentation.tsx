...
import { ArrowLeft, BookOpen, Shield, Users, Zap, Brain, Eye, CheckCircle2, AlertTriangle, Database, Lock, FileText } from "lucide-react";
      ...
      <section className="border-t border-border/50 bg-muted/30 py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            >
              <h2 className="text-3xl font-bold text-foreground mb-4">🎯 The Architecture</h2>
            ...
            <motion.div 
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="rounded-2xl border border-border/50 bg-card p-8 font-mono text-sm"
            >
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="max-w-5xl mx-auto">
          <motion.div 
            ...
            className="text-center mb-12"
          >
            <h2 className="text-3xl font-bold text-foreground mb-4">🎯 Real Business Impact</h2>
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="max-w-2xl mx-auto text-center">
          <motion.div 
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl font-bold text-foreground mb-4">🌟 Try It Yourself</h2>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <motion.div 
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-6">💬 Final Thought</h2>
