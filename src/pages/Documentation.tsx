...
const primarySections = [
  ...
  },
  {
    ...
    description: "Install AI Fabric 0.8.4, choose the smallest useful module set, and add your first AI-enabled application capability.",
...
const releaseFacts = [
  { value: "0.8.4", label: "Current release" },
