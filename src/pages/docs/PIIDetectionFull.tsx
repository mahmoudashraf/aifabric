...
import piiDetectionGuide from "@/content/PII-Detection-Story-LONG.md?raw";

const PAGE_TITLE = "PII Detection - Technical Reference";
const PAGE_DESCRIPTION = "Deep dive into AI Fabric's PII detection system, detection modes, pattern matching, encryption, and implementation guide.";
          ...
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div>
              ...
              <p className="text-muted-foreground mt-2">
                Complete technical reference for implementing automatic PII detection and redaction
              </p>
            </div>
            <div className="flex items-center gap-3">
              <StoryLoveButton storySlug="pii_detection_full_guide" />
              <PageViewCounter />
            </div>
          </div>
        </section>
...
export default PIIDetectionFull;
