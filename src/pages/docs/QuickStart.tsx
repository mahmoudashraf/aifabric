        ...
        <section className="px-6 py-12 border-b border-border/50">
          ...
          >
            ...
            <StepCard step={1} title="Add Dependencies" time="2 min" icon={<Package className="h-4 w-4 text-primary" />}>
              <p className="text-muted-foreground text-sm mb-4">Open your <code className="text-primary bg-muted px-1.5 py-0.5 rounded">pom.xml</code> and add these three AI Fabric 0.8.4 dependencies:</p>
              <CopyableCodeBlock 
                filename="pom.xml"
                language="xml"
                code={`<dependencies>
