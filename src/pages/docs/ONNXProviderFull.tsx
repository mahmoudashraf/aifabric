...
import onnxProviderGuide from "@/content/ONNX-Provider-Story-LONG.md?raw";

const PAGE_TITLE = "ONNX Provider - Technical Reference";
const PAGE_DESCRIPTION = "Deep dive into AI Fabric's ONNX provider, local embedding generation, tokenization, batch processing, GPU acceleration, and implementation guide.";
          ...
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div>
              ...
              <p className="text-muted-foreground mt-2">
                Complete technical reference for implementing local embeddings with zero cost and 100% privacy
              </p>
            </div>
            <div className="flex items-center gap-3">
              <StoryLoveButton storySlug="onnx_provider_full_guide" />
              <PageViewCounter />
            </div>
          </div>
        </section>
...
export default ONNXProviderFull;
