...
import relationshipQueryIntelligenceContent from "@/content/Relationship-Query-Intelligence-Story-LONG.md?raw";

const PAGE_TITLE = "Relationship Query Intelligence: Complete Technical Guide - AI Fabric Framework";
const PAGE_DESCRIPTION = "Complete technical guide to Relationship Query Intelligence: automatic schema discovery, LLM intent understanding, intelligent JPQL generation, and defense-in-depth access control.";
...
const RelationshipQueryIntelligenceFull = () => {
  useEffect(() => {
    ...
    <DocsLayout>
      <div className="min-h-screen">
          ...
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div>
              ...
              <h1 className="text-2xl md:text-3xl font-bold text-foreground">
                Relationship Query Intelligence: Complete Guide
              </h1>
              <p className="text-muted-foreground mt-2 max-w-2xl">
                Complete technical guide to automatic schema discovery, LLM intent understanding, intelligent JPQL generation, and defense-in-depth access control.
              </p>
            </div>
            <div className="flex items-center gap-3">
              <StoryLoveButton storySlug="relationship_query_intelligence_full" />
              <PageViewCounter />
            </div>
          </div>
        </section>
        ...
        >
          ...
          >
            {relationshipQueryIntelligenceContent}
          </ReactMarkdown>
        </motion.article>
...
export default RelationshipQueryIntelligenceFull;
