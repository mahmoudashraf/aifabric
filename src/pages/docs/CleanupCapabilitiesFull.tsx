...
import cleanupCapabilitiesGuide from "@/content/Cleanup-Capabilities-Story-LONG.md?raw";

const PAGE_TITLE = "Cleanup Capabilities - Technical Reference";
const PAGE_DESCRIPTION = "Deep dive into AI Fabric's cleanup capabilities, orphaned vector removal, retention policies, cleanup strategies, and implementation guide.";
          ...
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div>
              ...
              <p className="text-muted-foreground mt-2">
                Complete technical reference for implementing automatic cleanup with retention policies and compliance
              </p>
            </div>
            <div className="flex items-center gap-3">
              <StoryLoveButton storySlug="cleanup_capabilities_full_guide" />
              <PageViewCounter />
            </div>
          </div>
        </section>
...
export default CleanupCapabilitiesFull;
