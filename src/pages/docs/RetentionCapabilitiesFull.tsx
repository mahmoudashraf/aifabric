...
import retentionCapabilitiesGuide from "@/content/Retention-Capabilities-Story-LONG.md?raw";

const PAGE_TITLE = "Retention Capabilities - Technical Reference";
const PAGE_DESCRIPTION = "Deep dive into AI Fabric's retention capabilities, pluggable retention policy system, SPI pattern, GDPR/HIPAA compliance, and implementation guide.";
...
const RetentionCapabilitiesFull = () => {
  useEffect(() => {
          ...
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div>
              ...
              <p className="text-muted-foreground mt-2">
                Complete technical reference for implementing pluggable retention policies with SPI pattern and compliance
              </p>
            </div>
            <div className="flex items-center gap-3">
              <StoryLoveButton storySlug="retention_capabilities_full_guide" />
              <PageViewCounter />
            </div>
          </div>
        </section>
...
export default RetentionCapabilitiesFull;
