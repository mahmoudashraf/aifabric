...
import openAIProviderGuide from "@/content/OpenAI-Provider-Story-LONG.md?raw";

const PAGE_TITLE = "OpenAI Provider - Technical Reference";
const PAGE_DESCRIPTION = "Deep dive into AI Fabric's OpenAI provider, auto-configuration, health checks, metrics, and implementation guide.";
          ...
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div>
              ...
              <h1 className="text-2xl md:text-3xl font-bold text-foreground">
                OpenAI Provider: Production-Ready Integration
              </h1>
              <p className="text-muted-foreground mt-2">
                Complete technical reference for implementing OpenAI integration with zero boilerplate
              </p>
            </div>
            <div className="flex items-center gap-3">
              <StoryLoveButton storySlug="openai_provider_full_guide" />
              <PageViewCounter />
            </div>
          </div>
        </section>
...
export default OpenAIProviderFull;
