        ...
        <section className="border-b border-border/50 px-6 py-8">
          <div className="flex items-center justify-between flex-wrap gap-4">
            ...
            <div className="flex items-center gap-3">
              <StoryLoveButton storySlug="indexing_full_guide" />
              <PageViewCounter />
            </div>
          </div>
        </section>
        ...
        >
          ...
          <footer className="border-t border-border/50 pt-8 mt-12">
            <div className="flex flex-col items-center gap-4">
              <StoryLoveButton storySlug="indexing-story-full" />
...
export default IndexingStrategiesFull;
