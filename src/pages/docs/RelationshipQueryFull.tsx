...
import relationshipQueryGuide from "@/content/relationship-query-guide.md?raw";

const PAGE_TITLE = "Relationship Query - Complete Technical Guide";
const PAGE_DESCRIPTION = "Comprehensive technical reference for the Relationship Query module. Transform natural language into database queries with complete configuration and code examples.";
          ...
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div>
              ...
              <h1 className="text-2xl md:text-3xl font-bold text-foreground">
                Relationship Query - Complete Reference
              </h1>
              <p className="text-muted-foreground mt-2">
                Everything you need to configure, deploy, and optimize natural language database queries
              </p>
            </div>
            <div className="flex items-center gap-3">
              <StoryLoveButton storySlug="relationship_query_full_guide" />
              <PageViewCounter />
            </div>
          </div>
        </section>
          ...
          <footer className="border-t border-border/50 pt-8 mt-12">
            <div className="flex flex-col items-center gap-4">
              ...
              <p className="text-sm text-muted-foreground text-center">
                Part of the AI Fabric Framework documentation — complete technical reference
              </p>
            </div>
          </footer>
        </motion.article>
...
export default RelationshipQueryFull;
