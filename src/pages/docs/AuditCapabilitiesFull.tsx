...
import auditCapabilitiesGuide from "@/content/Audit-Capabilities-Story-LONG.md?raw";

const PAGE_TITLE = "Audit Capabilities - Technical Reference";
const PAGE_DESCRIPTION = "Deep dive into AI Fabric's audit capabilities, intent history, PII redaction, encryption, compliance reports, and implementation guide.";
          ...
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div>
              ...
              <p className="text-muted-foreground mt-2">
                Complete technical reference for implementing comprehensive audit logging with privacy protection and compliance
              </p>
            </div>
            <div className="flex items-center gap-3">
              <StoryLoveButton storySlug="audit_capabilities_full_guide" />
              <PageViewCounter />
            </div>
          </div>
        </section>
...
export default AuditCapabilitiesFull;
