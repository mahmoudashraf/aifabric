...
import accessPolicyGuide from "@/content/Access-Policy-Story-LONG.md?raw";

const PAGE_TITLE = "Custom Access Policy - Technical Reference";
const PAGE_DESCRIPTION = "Deep dive into AI Fabric's access control system, EntityAccessPolicy interface, fail-closed security model, and implementation guide.";
          ...
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div>
              ...
              <h1 className="text-2xl md:text-3xl font-bold text-foreground">
                Custom Access Policy: Building Fail-Closed Security
              </h1>
              <p className="text-muted-foreground mt-2">
                Complete technical reference for implementing pluggable access control
              </p>
            </div>
            <div className="flex items-center gap-3">
              <StoryLoveButton storySlug="access_policy_full_guide" />
              <PageViewCounter />
            </div>
          </div>
        </section>
...
export default AccessPolicyFull;
