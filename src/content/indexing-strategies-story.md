...
> *Narrative companion for AI Fabric 0.4.0. Use the current semantic-search and indexing guides for exact setup.*

**Status:** Narrative companion. Current implementation details are in the AI Fabric 0.4.0 guides.
